...
INSERT INTO adherent (login,mdp,nom,prenom,dateNaissance,rue,cp,ville,mail,token) 
VALUES('jonpie','motDePasse','Jonson','Pierre',TO_DATE('10-12-1990','DD-MM-YYYY'),'40 avenue de Brest','42150','Boston','pierre.jonson@gmail.com',NULL);
INSERT INTO adherent (login,mdp,nom,prenom,dateNaissance,rue,cp,ville,mail,token)
VALUES('marben','motDePasse2','Mare','Benjamin',TO_DATE('23-05-1996','DD-MM-YYYY'),'51 bvd des etats unis','60200','Compiegne','benjamin.mare@etu.utc.fr',NULL);
INSERT INTO adherent (login,mdp,nom,prenom,dateNaissance,rue,cp,ville,mail,token)
VALUES('proant','motDePasse3','Protard','Antoine',TO_DATE('10-02-1994','DD-MM-YYYYY'),'1 rue roger couttolenc','60200','Compiegne','antoine.protard@etu.utc.fr',NULL);
